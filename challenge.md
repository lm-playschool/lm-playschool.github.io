...
**Central research question:** Given a fixed token post-training budget, how can we best improve a pre-trained LM's capacity as a collaborative language user — and what role does structured agent interaction play in that process?
...
## Join the LM Playschool mailing list

[Subscribe to our mailing list](https://www.listserv.dfn.de/sympa/subscribe/llm-playschool-challenge) to receive all updates and announcements.
